...
class SimilarItems:
    ...
    def load(self, path, **kwargs):
        ...
        self._similar_items = pd.read_parquet(path, **kwargs).set_index("item_id_1")
...
async def lifespan(app: FastAPI):
    ...
    sim_items_store.load(
        os.path.join(os.getcwd(), "recommendations/similar_items.parquet"),
...
async def recommendations(item_id: int, k: int = 100):
    """
